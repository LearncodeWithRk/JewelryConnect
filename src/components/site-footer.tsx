    ...
    <footer className="bg-secondary text-secondary-foreground">
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold font-headline text-xl">JewelryConnect</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/booking" className="text-sm text-muted-foreground hover:text-primary">Jewelry Care</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t mt-8 pt-6 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} JewelryConnect. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
